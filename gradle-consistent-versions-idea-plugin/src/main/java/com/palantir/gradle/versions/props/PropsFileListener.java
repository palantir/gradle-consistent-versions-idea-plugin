...
public final class PropsFileListener implements AsyncFileListener {
    private static final Logger log = LoggerFactory.getLogger(PropsFileListener.class);
    ...
    private static boolean isFileMalformed(Project project, VirtualFile file) {
        ...
        if (psiFile == null || !(psiFile.getFileType() instanceof PropsFileType)) {
            return true;
        }
